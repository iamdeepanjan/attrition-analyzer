...
public class Employee {
    ...
    public Employee(String employeeId, String firstName, String lastName, String gender, int age, String businessTravel,
            String department, int distanceFromHomeKm, String state, String ethnicity, int education,
            String educationField, String jobRole, String maritalStatus, long salary, int stockOptionLevel,
            String overTime, LocalDate hireDate, String attrition, int yearsAtCompany, int yearsInMostRecentRole,
            int yearsSinceLastPromotion, int yearsWithCurrManager, String id) {
        super();
